from naive_bot_ccxt import NaiveBot

curr, sb, mta, tp, md, lev, mf, stp = 'ETH', 500, 10, 0.5, 1.6, 50, 1, 0.05
bot1 = NaiveBot()
...
bot1.dry_run(currency=curr, base='USDT', interval='1h', params=params)
